...
<section id="wrap">
	...
	<section class="contents">
		...
		<article>
			<span class="total">생물정보 수 : ${list_size}개</span>
			...
			<div class="board boardList"><!-- board -->
				<table>
					...
					<c:forEach var="lists" items="${data}">
						...
						<tr>
							<td><c:out value="${i}" /></td>
							<td><a href="biology_view.do?idx=${lists.idx}&title=${title}">${utility.getStrMUnitIdx(lists.munitidx)}</a></td>
	...
	<div class="btnBar"><a href="javascript:goPage('biology_theme.do');">테마목록</a></div>
	<!--// subwrap -->

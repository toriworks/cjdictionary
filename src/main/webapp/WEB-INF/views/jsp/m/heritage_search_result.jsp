	...
	<section class="contents">
		...
		<article>
			...
			<div class="searchResultTab">
				...
				<a href="javascript:searchHeritageImg();">"<c:out value="${refineEntryTitle}"/>" 관련 이미지 검색결과 <br />(<c:out value="${imgTotalCount}" />건)</a>
			</div>
			...
			<div class="board boardList"><!-- board -->
				<table>
					...
					<tbody>
						...
						<tr>
							<td><c:out value="${i}" /></td>
							<td><a href="heritage_view2.do?cat=2&idx=${lists.idx}">${lists.tag}</a></td>

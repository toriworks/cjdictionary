			...
			<ul class="themeT">
				<li>
					<a href="javascript:goPage(5, '우리나라의 세계유산');"><p>우리나라의 세계유산</p>
						<span style="font-size:15px;">수원 화성, 경주 불국사, 창덕궁, 남한산성, 합천 해인사…</span></a>
				</li>
				<li>
					<a href="javascript:goPage(7, '우리나라의 기록유산');"><p>우리나라의 기록유산</p>
						<span style="font-size:15px;">훈민정음, 이순신 난중일기, 동의보감, 조선왕조실록 태백산사고본…</span></a>
				</li>
				<li>
					<a href="javascript:goPage(6, '우리나라의 인류무형문화유산');"><p>우리나라의 인류무형문화유산</p>
						<span style="font-size:15px;">판소리, 강강술래, 남사당놀이, 종묘제례악, 강릉단오제…</span></a>
				</li>
				<li>
					<a href="javascript:goPage(4, '백제의 문화재');"><p>백제의 문화재</p>
						<span style="font-size:15px;">백제 금동대향로, 서울 몽촌토성, 무령왕 금귀걸이, 금동보살입상 …</span></a>
				</li>
				<li>
					<a href="javascript:goPage(8, '세종시 중요문화재');"><p>세종시 중요문화재</p>
						<span style="font-size:15px;">세종시 연화사 칠존불비상, 세종 유계화 가옥, 세종시 연화사 무인명불비상…</span></a>
				</li>
			</ul>
			<!--
			<div class="paging">
